...
```
## Output (man)
<br><img src="./media/q1-1-1.png" alt="output: man" height="100px">

## Output (--help)
<br><img src="./media/q1-1-2.png" alt="output: --help" height="100px">
...
## Output
<br><img src="./media/q1-1-3.png" alt="output: ls" height="100px">
...
## Output
<br><img src="./media/q1-1-4.png" alt="output: cat" height="100px">
...
## Output
<br><img src="./media/q1-1-5.png" alt="output: grep" height="100px">
...
## Output
<br><img src="./media/q1-1-6.png" alt="output: mkdir" height="100px">

## Output
<br><img src="./media/q1-1-7.png" alt="output: mkdir" height="100px">
...
## Output
<br><img src="./media/q1-1-8.png" alt="output: rmdir" height="100px">
...
## Output
<br><img src="./media/q1-1-9.png" alt="output: rm" height="100px">
...
## Output
<br><img src="./media/q1-1-10.png" alt="output: shred" height="100px">
...
## Output (cp)
<br><img src="./media/q1-1-11.png" alt="output: cp" height="100px">
...
## Output (mv)
<br><img src="./media/q1-1-12.png" alt="output: mv 1" height="100px">
<br><img src="./media/q1-1-13.png" alt="output: mv 2" height="100px">
...
## Output (chmod)
<br><img src="./media/q1-1-14.png" alt="output: chown" height="100px">

## Output (chown)
<br><img src="./media/q1-1-15.png" alt="output: chown" height="100px">
...
## Output
<br><img src="./media/q1-1-16.png" alt="output: sudo" height="100px">
...
## Output
<br><img src="./media/q1-1-17.png" alt="output: cal" height="100px">
...
## Output
<br><img src="./media/q1-1-18.png" alt="output: date" height="100px">
...
## Output
<br><img src=./media/q1-1-19.png" alt="output: timedatectl" height="100px">
...
## Output
<br><img src="./media/q1-1-20.png" alt="output: dd" height="100px">
...
```
## Output
<br><img src="./media/q1-1-21.png" alt="output: wc" height="100px">